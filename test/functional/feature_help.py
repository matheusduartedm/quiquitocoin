...
"""Verify that starting quiquitocoin with -h works as expected."""

from test_framework.test_framework import QuiquitocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(QuiquitocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start quiquitocoin with -h for help text")
        ...
        self.log.info("Start quiquitocoin with -version for version information")
        ...
        self.log.info("Start quiquitocoind with -fakearg to make sure it does not start")
