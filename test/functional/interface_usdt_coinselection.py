...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/quiquitocoin/quiquitocoin/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(QuiquitocoinTestFramework):
