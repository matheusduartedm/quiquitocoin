...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/quiquitocoin/quiquitocoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(QuiquitocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our quiquitocoind node")
