...
"""
Test starting quiquitocoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(QuiquitocoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that quiquitocoind has bound on "::1" (for RPC) and "::" (for P2P).
