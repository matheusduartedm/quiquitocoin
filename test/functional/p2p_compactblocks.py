...
# TestP2PConn: A peer we use to send messages to quiquitocoind, and store responses.
...
class CompactBlocksTest(QuiquitocoinTestFramework):
    ...
    # This test actually causes quiquitocoind to (reasonably!) disconnect us, so do this last.
    ...
    # quiquitocoind's choice of nonce.
    ...
    # Test that quiquitocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for quiquitocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # quiquitocoind will not send blocktxn responses for blocks whose height is
