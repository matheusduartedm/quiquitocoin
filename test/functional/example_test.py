...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QuiquitocoinTestFramework
    pass


class ExampleTest(QuiquitocoinTestFramework):
    # Each functional test is a subclass of the QuiquitocoinTestFramework class.
    ...
    def custom_method(self):
        ...
        QuiquitocoinTestFramework class so other tests can use it."""
