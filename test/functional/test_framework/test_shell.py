...
class TestShell:
    """Wrapper Class for QuiquitocoinTestFramework.

    The TestShell class extends the QuiquitocoinTestFramework
    ...
    class __TestShell(QuiquitocoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by QuiquitocoinTestFramework child class.
            self.num_nodes = 1
