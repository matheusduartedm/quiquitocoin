...
class TestQuiquitocoinCli(QuiquitocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `quiquitocoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and quiquitocoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and quiquitocoin-cli getwalletinfo return expected wallet info")
            ...
            # Test quiquitocoin-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test quiquitocoin-cli -generate with -rpcwallet in multiwallet mode.
