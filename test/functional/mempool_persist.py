...
By default, quiquitocoind will dump mempool on shutdown and
...
class MempoolPersistTest(QuiquitocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent quiquitocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
