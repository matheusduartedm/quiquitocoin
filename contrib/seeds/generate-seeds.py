...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef QUIQUITOCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define QUIQUITOCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the quiquitocoin network\n')
    ...
    g.write('#endif // QUIQUITOCOIN_CHAINPARAMSSEEDS_H\n')
