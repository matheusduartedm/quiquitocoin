...
complete --command quiquitocoind --no-files

# Extract options
function __fish_quiquitocoind_get_options
...
complete \
    --command quiquitocoind \
    --arguments "(__fish_quiquitocoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command quiquitocoind \
...
complete \
    --command quiquitocoind \
    --arguments "(__fish_quiquitocoind_get_options --nofiles)"
