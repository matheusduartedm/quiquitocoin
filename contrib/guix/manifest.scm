...
(define* (make-quiquitocoin-cross-toolchain target
                                       #:key
...
desirable for building Quiquitocoin Core release binaries."
...
;; failure; see https://github.com/quiquitocoin/quiquitocoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-quiquitocoin-cross-toolchain target)))
