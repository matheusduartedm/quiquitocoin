...
"""Example logging Quiquitocoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/quiquitocoind
...
def main(quiquitocoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[quiquitocoind_with_usdts])
