...
""" Interactive quiquitocoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Quiquitocoin Core can enable. It uses BCC
...
def main(quiquitocoind_path):
    ...
    quiquitocoind_with_usdts.enable_probe(
