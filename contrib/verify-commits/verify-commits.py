...
def tree_sha512sum(commit='HEAD'):
    ...
    This is copied from github-merge.py. See https://github.com/quiquitocoin-core/quiquitocoin-maintainer-tools."""
...
def main():
    ...
    while True:
        ...
        os.environ['QUIQUITOCOIN_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
