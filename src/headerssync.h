...
#ifndef QUIQUITOCOIN_HEADERSSYNC_H
#define QUIQUITOCOIN_HEADERSSYNC_H
 ...
 *
 * The Quiquitocoin protocol does not offer an easy way to determine the work on a
...
#endif // QUIQUITOCOIN_HEADERSSYNC_H
