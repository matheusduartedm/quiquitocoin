...
// Copyright 2015 Quiquitocoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef QUIQUITOCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define QUIQUITOCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // QUIQUITOCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
