...
#ifndef QUIQUITOCOIN_INTERFACES_INIT_H
#define QUIQUITOCOIN_INTERFACES_INIT_H
...
//! (quiquitocoin-gui, quiquitocoin-node, quiquitocoin-wallet, quiquitocoind, quiquitocoin-qt) and each
...
#endif // QUIQUITOCOIN_INTERFACES_INIT_H
