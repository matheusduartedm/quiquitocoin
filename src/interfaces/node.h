...
#ifndef QUIQUITOCOIN_INTERFACES_NODE_H
#define QUIQUITOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a quiquitocoin node (quiquitocoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or quiquitocoin.conf.
...
#endif // QUIQUITOCOIN_INTERFACES_NODE_H
