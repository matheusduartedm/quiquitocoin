...
#ifndef QUIQUITOCOIN_WALLET_TRANSACTION_H
#define QUIQUITOCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this quiquitocoin node, and set to 0 for transactions that were created
...
#endif // QUIQUITOCOIN_WALLET_TRANSACTION_H
