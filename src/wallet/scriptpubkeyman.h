...
#ifndef QUIQUITOCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define QUIQUITOCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Quiquitocoin Core wallet was originally a collection of unrelated private
...
#endif // QUIQUITOCOIN_WALLET_SCRIPTPUBKEYMAN_H
