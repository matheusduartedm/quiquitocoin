...
#ifndef QUIQUITOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define QUIQUITOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // QUIQUITOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
