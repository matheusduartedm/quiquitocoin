...
#ifndef QUIQUITOCOIN_WALLET_WALLETUTIL_H
#define QUIQUITOCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! quiquitocoin from opening the wallet, thinking it was newly created, and
...
#endif // QUIQUITOCOIN_WALLET_WALLETUTIL_H
