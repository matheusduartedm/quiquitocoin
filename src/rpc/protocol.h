...
#ifndef QUIQUITOCOIN_RPC_PROTOCOL_H
#define QUIQUITOCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in quiquitocoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Quiquitocoin is not connected
...
#endif // QUIQUITOCOIN_RPC_PROTOCOL_H
