...
#ifndef QUIQUITOCOIN_COMPAT_ASSUMPTIONS_H
#define QUIQUITOCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Quiquitocoin cannot be compiled without assertions."
#endif
...
#endif // QUIQUITOCOIN_COMPAT_ASSUMPTIONS_H
