...
#ifndef QUIQUITOCOIN_ARITH_UINT256_H
#define QUIQUITOCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Quiquitocoin only uses this "compact" format for encoding difficulty
...
#endif // QUIQUITOCOIN_ARITH_UINT256_H
