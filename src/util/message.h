...
#ifndef QUIQUITOCOIN_UTIL_MESSAGE_H
#define QUIQUITOCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's quiquitocoin address, it must refer to a public key.
...
#endif // QUIQUITOCOIN_UTIL_MESSAGE_H
