...
#ifndef QUIQUITOCOIN_QT_SENDCOINSDIALOG_H
#define QUIQUITOCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending quiquitocoins */
...
#endif // QUIQUITOCOIN_QT_SENDCOINSDIALOG_H
