...
#ifndef QUIQUITOCOIN_QT_WALLETMODEL_H
#define QUIQUITOCOIN_QT_WALLETMODEL_H
...
/** Interface to Quiquitocoin wallet from Qt view code. */
...
#endif // QUIQUITOCOIN_QT_WALLETMODEL_H
