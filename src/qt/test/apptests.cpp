...
//! Entry point for QuiquitocoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &QuiquitocoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for QuiquitocoinGUI tests.
void AppTests::guiTests(QuiquitocoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &QuiquitocoinGUI::consoleShown, this, &AppTests::consoleTests);
