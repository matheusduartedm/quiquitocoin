...
#ifndef QUIQUITOCOIN_QT_ADDRESSTABLEMODEL_H
#define QUIQUITOCOIN_QT_ADDRESSTABLEMODEL_H
...
public:
    ...
    enum ColumnIndex {
        ...
        Address = 1  /**< Quiquitocoin address */
    };
...
#endif // QUIQUITOCOIN_QT_ADDRESSTABLEMODEL_H
