      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->quiquitocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->quiquitocoinAtStartup);
    ...
    ui->quiquitocoinAtStartup->setToolTip(ui->quiquitocoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->quiquitocoinAtStartup->setText(ui->quiquitocoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openQuiquitocoinConfButton->setToolTip(ui->openQuiquitocoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new QuiquitocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->quiquitocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openQuiquitocoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openQuiquitocoinConf())
