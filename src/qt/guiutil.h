...
#ifndef QUIQUITOCOIN_QT_GUIUTIL_H
#define QUIQUITOCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Quiquitocoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "quiquitocoin:" URI into recipient object, return true on successful parsing
...
#endif // QUIQUITOCOIN_QT_GUIUTIL_H
