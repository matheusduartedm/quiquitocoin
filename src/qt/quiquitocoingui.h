...
#ifndef QUIQUITOCOIN_QT_QUIQUITOCOINGUI_H
#define QUIQUITOCOIN_QT_QUIQUITOCOINGUI_H
...
/**
  Quiquitocoin GUI main class. This class represents the main window of the Quiquitocoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class QuiquitocoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit QuiquitocoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~QuiquitocoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a quiquitocoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, QuiquitocoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Quiquitocoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(QuiquitocoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // QUIQUITOCOIN_QT_QUIQUITOCOINGUI_H
