...
#ifndef QUIQUITOCOIN_TEST_SCRIPTNUM10_H
#define QUIQUITOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Quiquitocoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // QUIQUITOCOIN_TEST_SCRIPTNUM10_H
