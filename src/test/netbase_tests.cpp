...
{
    BOOST_CHECK(TestSplitHost("www.quiquitocoincore.org", "www.quiquitocoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.quiquitocoincore.org]", "www.quiquitocoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.quiquitocoincore.org:80", "www.quiquitocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.quiquitocoincore.org]:80", "www.quiquitocoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.quiquitocoincore.org:65536", "www.quiquitocoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.quiquitocoincore.org:0", "www.quiquitocoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.quiquitocoincore.org:", "www.quiquitocoincore.org:", 0, false));
}
