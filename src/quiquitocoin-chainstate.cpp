...
//
// The quiquitocoin-chainstate executable serves to surface the dependencies required
// by a program wishing to use Quiquitocoin Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from Quiquitocoin Core's coding style.
//
// It is part of the libquiquitocoinkernel project.
