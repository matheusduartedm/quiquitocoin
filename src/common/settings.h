...
#ifndef QUIQUITOCOIN_COMMON_SETTINGS_H
#define QUIQUITOCOIN_COMMON_SETTINGS_H
...
//!       https://github.com/quiquitocoin/quiquitocoin/pull/15934/files#r337691812)
...
#endif // QUIQUITOCOIN_COMMON_SETTINGS_H
