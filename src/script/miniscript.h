...
#ifndef QUIQUITOCOIN_SCRIPT_MINISCRIPT_H
#define QUIQUITOCOIN_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a quiquitocoin script
...
#endif // QUIQUITOCOIN_SCRIPT_MINISCRIPT_H
