...
#ifndef QUIQUITOCOIN_SCRIPT_SCRIPT_H
#define QUIQUITOCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Quiquitocoin always counted CHECKMULTISIGs
...
#endif // QUIQUITOCOIN_SCRIPT_SCRIPT_H
