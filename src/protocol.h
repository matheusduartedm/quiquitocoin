...
#ifndef QUIQUITOCOIN_PROTOCOL_H
#define QUIQUITOCOIN_PROTOCOL_H
...
/**
 * Quiquitocoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Quiquitocoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // quiquitocoin-development mailing list. Remember that service bits are just
