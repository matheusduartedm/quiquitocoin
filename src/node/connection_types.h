...
#ifndef QUIQUITOCOIN_NODE_CONNECTION_TYPES_H
#define QUIQUITOCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/quiquitocoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Quiquitocoin’s Peer-to-Peer Network")
...
#endif // QUIQUITOCOIN_NODE_CONNECTION_TYPES_H
