...
#ifndef QUIQUITOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define QUIQUITOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // QUIQUITOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
