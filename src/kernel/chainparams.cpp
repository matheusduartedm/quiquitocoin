...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.quiquitocoin.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.quiquitocoin.dashjr-list-of-p2p-nodes.us."); // Luke Dashjr
        vSeeds.emplace_back("seed.quiquitocoinstats.com."); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.quiquitocoin.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btc.petertodd.org."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.quiquitocoin.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.quiquitocoin.wiz.biz."); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.quiquitocoin.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tbtc.petertodd.org.");
        vSeeds.emplace_back("seed.testnet.quiquitocoin.sprovoost.nl.");
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.quiquitocoin.sprovoost.nl.");
