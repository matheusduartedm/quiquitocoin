...
#ifndef QUIQUITOCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define QUIQUITOCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // QUIQUITOCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
