...
#ifndef QUIQUITOCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
#define QUIQUITOCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
...
#endif // QUIQUITOCOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
