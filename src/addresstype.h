...
#ifndef QUIQUITOCOIN_ADDRESSTYPE_H
#define QUIQUITOCOIN_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a quiquitocoin address
 */
...
/**
 * Generate a Quiquitocoin scriptPubKey for the given CTxDestination. Returns a P2PKH
 * script for a CKeyID destination, a P2SH script for a CScriptID, and an empty
 * script for CNoDestination.
 */
CScript GetScriptForDestination(const CTxDestination& dest);

#endif // QUIQUITOCOIN_ADDRESSTYPE_H
