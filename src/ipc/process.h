...
#ifndef QUIQUITOCOIN_IPC_PROCESS_H
#define QUIQUITOCOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning quiquitocoin processes and serving requests
...
#endif // QUIQUITOCOIN_IPC_PROCESS_H
