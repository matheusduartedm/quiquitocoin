...
libs = [
    'libquiquitocoin_cli',
    'libquiquitocoin_common',
    'libquiquitocoin_crypto',
    'libquiquitocoin_node',
    'libquiquitocoin_util',
    'libquiquitocoin_wallet_tool',
    'libquiquitocoin_wallet',
    'libquiquitocoin_zmq',
    'bench_quiquitocoin',
    'libtest_util',
]
...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Quiquitocoin Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/quiquitocoin_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/quiquitocoin_config.h'), "w", encoding="utf8") as btc_config:
...
def main():
    parser = argparse.ArgumentParser(description='Quiquitocoin-core msbuild configuration initialiser.')
    ...
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/quiquitocoin_config.h'), os.path.join(SOURCE_DIR, 'config/quiquitocoin-config.h'))
