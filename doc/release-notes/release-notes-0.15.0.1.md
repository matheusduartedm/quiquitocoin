Quiquitocoin Core version *0.15.0.1* is now available from:

  <https://quiquitocoin.org/bin/quiquitocoin-core-0.15.0.1/>

and

  <https://quiquitocoincore.org/bin/quiquitocoin-core-0.15.0.1/>
