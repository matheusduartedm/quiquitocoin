Quiquitocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/quiquitocoin/files/Quiquitocoin/quiquitocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Quiquitocoin
...
New/changed settings (command-line or quiquitocoin.conf file)
--------------------------------------------------------
