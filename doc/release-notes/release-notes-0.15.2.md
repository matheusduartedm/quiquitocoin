Quiquitocoin Core version *0.15.2* is now available from:

  <https://quiquitocoincore.org/bin/quiquitocoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in quiquitocoin-tx (TheBlueMatt)
