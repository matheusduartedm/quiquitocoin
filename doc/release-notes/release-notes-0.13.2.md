Quiquitocoin Core version 0.13.2 is now available from:

  <https://quiquitocoin.org/bin/quiquitocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update quiquitocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow quiquitocoin-tx to create v2 transactions (btcdrak)
