...
Quiquitocoin Core version 0.19.1 is now available from:

  <https://quiquitocoincore.org/bin/quiquitocoin-core-0.19.1/>
...
From Quiquitocoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Quiquitocoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Quiquitocoin Core does not yet change appearance when
...
- #17488 fix "quiquitocoind already running" warnings on macOS (fanquake)
