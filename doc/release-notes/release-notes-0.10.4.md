Quiquitocoin Core version 0.10.4 is now available from:

  <https://quiquitocoin.org/bin/quiquitocoin-core-0.10.4/>
...
- #6953 `43c2789` Split quiquitocoin-tx into its own package
- #6953 `dfe0d4d` Include quiquitocoin-tx binary on Debian/Ubuntu
