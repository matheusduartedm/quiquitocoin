Quiquitocoin Core version 0.16.1 is now available from:

  <https://quiquitocoincore.org/bin/quiquitocoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting quiquitocoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure quiquitocoind processes are cleaned up when tests end (sdaftuar)
