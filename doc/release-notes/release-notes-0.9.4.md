Quiquitocoin Core version 0.9.4 is now available from:

  https://quiquitocoin.org/bin/0.9.4/
...
this update is incompatible with the Quiquitocoin system and could lead to consensus
forks.

Quiquitocoin Core released binaries from https://quiquitocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~quiquitocoin/+archive/ubuntu/quiquitocoin
- A third-party or self-compiled Quiquitocoin Core

upgrade to Quiquitocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
