...
This document provides guidelines for internationalization of the Quiquitocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `quiquitocoin_en.ts` remains unchanged.
